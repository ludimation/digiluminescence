...
fprintf('Loading output data \n');
    % Only load data if the data has not yet been loaded
    if (...
            ~exist('output_C_all'                   , 'var'	) || ...
            ~exist('output_cleanPlate'              , 'var'	) || ...
            ~exist('output_denseCorr_all'           , 'var' ) || ...
            ~exist('output_denseCorr_masked_all'    , 'var' ) || ...
            ~exist('output_denseCorr_multiframe_all', 'var' ) || ...
            ~exist('output_digiLum_all'             , 'var' ) || ...
            ~exist('output_grid_all'                , 'var' ) || ...
            ~exist('output_j_features'              , 'var' ) || ...
            ~exist('output_uMasks_all'              , 'var' )...
            )
        load('digiluminescence_outputdata_20140505_0908.mat')
    end
% print time
toc
